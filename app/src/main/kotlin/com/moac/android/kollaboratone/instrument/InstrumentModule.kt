...
class InstrumentModule(val width: Int, val height: Int, val playerModule: PlayerModule, val rendererModule: RendererModule) {
    ...
    private fun provideInitialBalls(): Collection<Ball> {
        ...
        val b2plus1: Ball = Ball("2+1", OctaveNote(KEY.get(2), 1), COLORS.get(8), 80F, (widthSegment * 3).toFloat(), halfHeight, Velocity(0, localSpeed(10), Direction.NONE, Direction.DOWN), false)
        ...
        val b3plus1: Ball = Ball("3+1", OctaveNote(KEY.get(4), 1), COLORS.get(7), 100F, (widthSegment * 6).toFloat(), halfHeight, Velocity(localSpeed(5), localSpeed(10), Direction.LEFT, Direction.DOWN), false)
